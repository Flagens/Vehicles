...
public class Motobike extends CombustionEngineVehicle implements interfaceCar {
    public Motobike(Integer price, Color colour, String vehicleName, Integer maxSpeed, CombustionEngine engine, int tankCapacity) {
