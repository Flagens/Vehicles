...
public class CarAmphibia extends CombustionEngineVehicle implements interfaceCar, interfaceSship {
    public CarAmphibia(Integer price, Color colour, String vehicleName, Integer maxSpeed, CombustionEngine engine, int tankCapacity) {
    ...
    public void swim(int velocity) {
        System.out.println("Umiem plywac z predkoscia" + velocity);
    }
}
