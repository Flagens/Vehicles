...
public class DeliveryVan extends CombustionEngineVehicle implements interfaceCar {
    public DeliveryVan(Integer price, Color colour, String vehicleName, Integer maxSpeed, CombustionEngine engine, int tankCapacity) {
