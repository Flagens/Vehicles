...
public class Sedan extends CombustionEngineVehicle implements interfaceCar {
    public Sedan(Integer price, Color colour, String vehicleName, Integer maxSpeed, CombustionEngine engine, int tankCapacity) {
